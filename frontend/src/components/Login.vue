<template>
  <div class="relative w-full max-w-lg animate-fade-in px-4 sm:px-6 lg:px-8">
    <!-- Fons decoratiu suau -->
    ...
    <div class="bg-white rounded-[2.5rem] sm:rounded-3xl transition-all duration-300 relative z-10 p-6 sm:p-8 md:p-12 border border-slate-200/60 shadow-2xl">
