...
export class Matricula {
    ...
    @ManyToOne(() => Usuari, (usuari) => usuari.matricules, { onDelete: 'CASCADE' })
    ...
    @ManyToOne(() => Assignatura, (assignatura) => assignatura.matricules, { onDelete: 'CASCADE' })
    ...
    @Column({ type: 'enum', enum: MatriculaEstat, default: MatriculaEstat.MATRICULAT })
