...
import type { GamificacioData, DadesFamiliars, ConfiguracioUsuari } from '../users/interfaces/dades-usuari.interface';
...
export class Usuari {
    ...
    @ManyToOne(() => Grup, (grup) => grup.alumnes, { onDelete: 'SET NULL', nullable: true })
    ...
    @Column({
        ...
        type: 'json',
        nullable: true,
        default: () => "(JSON_OBJECT('ratxa_actual', 0, 'punts', 0, 'insignies', JSON_ARRAY()))",
    })
    ...
    @Column({ name: 'caducitat_token_recuperacio', type: 'datetime', nullable: true })
