...
export class UsersService {
    ...
    async getAlumneStats(id: number) {
        ...
        const assistencies = await this.assistenciaRepositori.find({
            where: { alumne: { id: id } },
            relations: ['sessio', 'sessio.assignacioDocent', 'sessio.assignacioDocent.assignatura'],
        ...
        const sorted = [...assistencies].sort((a, b) => b.dataRegistre.getTime() - a.dataRegistre.getTime());
